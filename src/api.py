...
async def ask(
    ...
    if len(contextual_query.split()) < 12:
        improved_query = rewrite_query(contextual_query)
    else:
...
# @app.get("/ask")
# async def ask(query: str, session_id: str = "default",subject: str = None, chapter: str = None):
...
#         improved_query = rewrite_query(query, history)
#     else:
